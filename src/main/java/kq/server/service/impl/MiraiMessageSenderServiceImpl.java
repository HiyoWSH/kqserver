...
public class MiraiMessageSenderServiceImpl implements MiraiMessageSenderService {
    ...
    private static final String authKey = "1234567890";
    private static final String GROUP_MESSAGE_URL = "http://127.0.0.1:8080/sendGroupMessage";
    private static final String FRIEND_MESSAGE_URL = "http://127.0.0.1:8080/sendFriendMessage";
    private static final String IMAGE_MESSAGE_URL = "http://127.0.0.1:8080/sendImageMessage";
    ...
    private static String getTargetUrl(MiraiMessage message) {
        switch (message.getType()){
            case "FriendMessage":
                return FRIEND_MESSAGE_URL;
            case "GroupMessage":
                return GROUP_MESSAGE_URL;
            case "ImageMessage":
                return IMAGE_MESSAGE_URL;
        }
        return null;
    }
    ...
    public String checkSessionOnly() {
        String url = "http://127.0.0.1:8080/verify";
        JSONObject json = new JSONObject();
        json.put("sessionKey", session);
        json.put("qq", 627985299);
    ...
    public void cleanSession(){
        String url = "http://127.0.0.1:8080/release";
        JSONObject json = new JSONObject();
        json.put("sessionKey", session);
        json.put("qq", 627985299);
    ...
    public void recallMessage(int id){
        String url = "http://127.0.0.1:8080/recall";
        JSONObject json = new JSONObject();
        json.put("sessionKey", session);
        json.put("target", id);
        post(url, createHttpEntity(json));
    ...
    public String uploadImage(String imgPath){
        String url = "http://127.0.0.1:8080/uploadImage";
